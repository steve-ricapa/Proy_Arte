...
export default function ExperiencePage({ onBack }) {
  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 mx-auto w-[min(1180px,94vw)] py-6 md:py-10">
        <header className="relative overflow-hidden rounded-3xl border border-purple-500/20 bg-black/60 px-5 py-7 shadow-2xl backdrop-blur-md md:px-8">
          ...
          <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <h1 className="mt-2 text-2xl font-extrabold leading-tight text-white sm:text-3xl md:text-5xl">
            ...
            <button
              type="button"
              onClick={onBack}
              className="btn-cosmic shrink-0 self-start px-5 py-3 md:px-10 md:py-4"
            >
              ← Volver
            </button>
          </div>
        ...
        <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <button
            ...
            className="group relative overflow-hidden rounded-xl border border-purple-500/20 bg-purple-950/20 px-4 py-2.5 text-left text-xs font-mono font-semibold text-purple-300 transition-all duration-300 hover:bg-purple-900/30 hover:border-purple-500/40 hover:text-white sm:text-center"
          >
            <span className="flex items-center gap-2">
