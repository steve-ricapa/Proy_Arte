    ...
    <div className="mt-5 rounded-2xl border border-white/10 bg-slate-950/55 px-4 py-4 shadow-inner">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-lg font-semibold text-white">{currentLabel}</p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            disabled={disabled}
            className="rounded-full border border-purple-300/20 bg-purple-300/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-purple-100 transition hover:bg-purple-300/20 disabled:cursor-not-allowed disabled:opacity-40"
          >
          ...
          <button
            ...
            onClick={onReset}
            disabled={disabled}
            className="rounded-full border border-white/12 bg-white/5 px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-slate-200 transition hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-40"
          >
            Reset
          </button>
        </div>
